...
import '../bloc/attachment_list_bloc/bloc.dart';
import '../widget/button_next_3_widget.dart';
import 'package:path/path.dart' as path;

class FormSurvey3OnlineScreen extends StatefulWidget {
  const FormSurvey3OnlineScreen({super.key, required this.argsSubmitDataModel});
  final ArgsSubmitDataModel argsSubmitDataModel;
  @override
  State<FormSurvey3OnlineScreen> createState() =>
      _FormSurvey3OnlineScreenState();
}

class _FormSurvey3OnlineScreenState extends State<FormSurvey3OnlineScreen> {
  ...
  void initState() {
    attachmentListBloc
        .add(AttachmentListAttempt(widget.argsSubmitDataModel.taskList.code!));
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushNamed(
                    ...
                    .then((value) => attachmentListBloc.add(
                      ...
                      listeners: [
                        BlocListener(
                          ...
                          listener: (_, AttachmentListState state) async {
                            if (state is AttachmentListLoading) {
                              setState(() {
                                isLoading = true;
                              });
                            }
                              ...
                              : Expanded(
                                  child: ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        final ext = path
                                            .extension(data[index].fileName!);
                                        final fp = path
                                            .extension(data[index].filePath!);
                                        log(fp);
                                        return Container(
                                                        ...
                                                        if (ext == '.PDF') {
                                                          if (data[index]
                                                            ...
                                                            Navigator.pushNamed(
                                                                ...
                                                                arguments: ArgsPreviewAttachmentModel(
                                                                    data[index]
                                                                        .fileName!,
                                                                    data[index]
                                                                        .filePath!));
